...
import { createContactMessage, createExportInquiry, createProduct, getProductBySlug, listAllProducts, listExportInquiries, listProducts } from "./db";
...
export const appRouter = router({
  ...
  admin: router({ products: adminProcedure.query(() => listAllProducts()), createProduct: adminProcedure.input(productInput).mutation(({ input }) => createProduct(input)) }),
