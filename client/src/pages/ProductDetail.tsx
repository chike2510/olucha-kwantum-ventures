...
export default function ProductDetail() {
  ...
  const cartProduct: StoreProduct = previewItem || { id: item?.id || 999, slug: params?.slug || "product", name: itemName, category: normalizedCategory, price: numericPrice, unit: itemUnit, description: itemDescription, color: itemColor, tag: "Available", specs: Object.fromEntries(specifications) };
